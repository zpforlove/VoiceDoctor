...
本项目流畅运行需要先下载 [MeloTTS](https://github.com/myshell-ai/MeloTTS) 到项目目录并按照提示配置好相应环境，接着在环境变量里面设置完成 [DeepSeek API](https://platform.deepseek.com/usage) 。接着，您需要安装项目的依赖环境（建议Pytorch安装GPU版本）。
```shell
